    ...
    //METODOS
        ...
        aumentarContador(){ // Este metodo lo que va a hacer es aumentar el numero de personas que esperan
            ...
            if(this.contadorCola >= 4){
                ...
                let tiempo = Math.round((Math.abs(tiempoFinal - this.horaApertura))/1000);
                alert(`Tienes muchos clientes esperando en la caja ${this.contadorCola}. Total de tiempo a esperar: ${tiempo}s.`);
            }
